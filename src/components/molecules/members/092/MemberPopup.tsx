...
const MemberPopup = ({ isOpen, onClose }: MemberPopupProps) => {
  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-hidden px-4">
      ...
      <div className="relative z-10 h-[100dvh] max-h-[100dvh] w-full max-w-[720px] animate-[member-popup-show_200ms_ease-out] overflow-y-auto overscroll-contain rounded-2xl border border-white/20 bg-white/10 p-6 text-white shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl sm:p-8">
