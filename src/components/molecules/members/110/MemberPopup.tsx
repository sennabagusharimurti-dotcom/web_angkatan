  ...
  return createPortal(
    ...
    <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto px-4">
      ...
      <div className="border-neutral-cs-10 bg-blue-cs-40 relative z-10 max-h-[100dvh] w-full max-w-[720px] animate-[member-popup-show_200ms_ease-out] overflow-y-auto rounded-2xl border-2 p-6 text-white shadow-xl sm:p-8">
        ...
        <div className="pr-10">
          {/* UBAH NAMA ANDA */}
          <h2 className="text-2xl font-black">Bambang Nasarillah K</h2>
          {/* UBAH NRP DAN ASAL */}
          <p className="text-neutral-cs-10/70 mt-1 text-sm font-semibold">5027251110 - Sorowako</p>
        </div>
        ...
        <div className="mt-5 flex gap-2">
          ...
          <LinkedInButtonLink username="bambang-nasarillah-kurniawan" />
        </div>
        ...
        <div className="border-neutral-cs-10/40 mt-4 rounded-xl border p-4">
          ...
          <p className="text-neutral-cs-10/60 text-xs font-bold tracking-wide uppercase">Mulai</p>
