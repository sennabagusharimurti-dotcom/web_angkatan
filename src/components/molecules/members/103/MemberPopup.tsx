...
const handleTextClick = () => {
  ...
  <div
    ...
    "
  >
    <div className="absolute left-8 top-8 text-7xl opacity-70">
      🕊️
    </div>

    <div className="absolute right-12 top-16 text-3xl text-[#D4AF37]">
      ✦
    </div>

    <div className="absolute bottom-20 left-16 text-2xl text-[#D4AF37]">
      ✦
    </div>

    <div className="absolute bottom-24 right-20 text-4xl text-[#D4AF37]">
      ✦
    </div>
